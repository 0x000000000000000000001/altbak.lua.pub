...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Control_Monad_RWS_Trans_newtypeRWST': $v = (($GLOBALS['Data_Newtype_Newtype__dollar__Dict'] ?? \Data\Newtype\phpurs_eval_thunk('Data_Newtype_Newtype__dollar__Dict')))((object)["Coercible0" => (function() {
  ...
  return $__fn;
      ...
      case 'Control_Monad_RWS_Trans_lazyRWST': $v = (($GLOBALS['Control_Lazy_Lazy__dollar__Dict'] ?? \Control\Lazy\phpurs_eval_thunk('Control_Lazy_Lazy__dollar__Dict')))((object)["defer" => (function() {
  $__fn = function($f) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($f) {
...
function Control_Monad_RWS_Trans_compose($f, $g = null, $x = null) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Control_Monad_RWS_Trans_compose';
  if ($__num < 3) {
...
$GLOBALS['Control_Monad_RWS_Trans_compose'] = __NAMESPACE__ . '\\Control_Monad_RWS_Trans_compose';
...
function Control_Monad_RWS_Trans_withRWST($f, $m = null) {
  $__num = func_num_args();
  ...
  if ($__num < 2) {
    ...
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($m, $f) {
...
throw new \Exception("Pattern match failure");
    ...
    $__res = (($GLOBALS['Data_Tuple_uncurry'] ?? \Data\Tuple\phpurs_eval_thunk('Data_Tuple_uncurry')))($__case_res_0, ($f)($r, $s));
  return $__num > 2 ? $__res(...array_slice(func_get_args(), 2)) : $__res;
  };
  return $__fn;
})());
...
$mempty = (($GLOBALS['Data_Monoid_mempty'] ?? \Data\Monoid\phpurs_eval_thunk('Data_Monoid_mempty')))($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Trans_Class_MonadTrans__dollar__Dict'] ?? \Control\Monad\Trans\Class\phpurs_eval_thunk('Control_Monad_Trans_Class_MonadTrans__dollar__Dict')))((object)["lift" => (function() use ($mempty) {
...
$pure = (($GLOBALS['Control_Applicative_pure'] ?? \Control\Applicative\phpurs_eval_thunk('Control_Applicative_pure')))((($dictMonad)->Applicative0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
  ...
  if ($__num < 1) {
    ...
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($bind, $m, $pure, $mempty) {
  ...
  if ($__num < 1) {
    ...
    $__res = ($pure)((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s, $a, $mempty));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})());
...
$f1 = $__case_0;
$m = $__case_1;
return (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($f1, $m) {
...
$f1 = $__case_0;
$m = $__case_1;
return (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($map, $f1, $m) {
...
$result = ($__case_0)->v1;
$writer = ($__case_0)->v2;
return (($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($state, ($f1)($result), $writer);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$state = ($__case_0)->v0;
$writer = ($__case_0)->v2;
return ($pure)((($GLOBALS['Data_Tuple_Tuple'] ?? \Data\Tuple\phpurs_eval_thunk('Data_Tuple_Tuple')))($state, $writer));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$result = ($__case_0)->v1;
$writer = ($__case_0)->v2;
return ($pure)((($GLOBALS['Data_Tuple_Tuple'] ?? \Data\Tuple\phpurs_eval_thunk('Data_Tuple_Tuple')))($result, $writer));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$Functor0 = (((($dictBind)->Apply0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))))->Functor0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined')));
$mapFlipped = (($GLOBALS['Data_Functor_mapFlipped'] ?? \Data\Functor\phpurs_eval_thunk('Data_Functor_mapFlipped')))($Functor0);
$functorRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_functorRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_functorRWST')))($Functor0);
...
$append = (($GLOBALS['Data_Semigroup_append'] ?? \Data\Semigroup\phpurs_eval_thunk('Data_Semigroup_append')))((($dictMonoid)->Semigroup0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
    $__res = (($GLOBALS['Control_Apply_Apply__dollar__Dict'] ?? \Control\Apply\phpurs_eval_thunk('Control_Apply_Apply__dollar__Dict')))((object)["apply" => (function() use ($bind, $mapFlipped, $append) {
...
$f = $__case_0;
$m = $__case_1;
return (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($bind, $f, $mapFlipped, $m, $append) {
...
return (($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s__prime____prime__, ($f__prime__)($a__prime____prime__), ($append)($w__prime__, $w__prime____prime__));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$bind = (($GLOBALS['Control_Bind_bind'] ?? \Control\Bind\phpurs_eval_thunk('Control_Bind_bind')))($dictBind);
$mapFlipped = (($GLOBALS['Data_Functor_mapFlipped'] ?? \Data\Functor\phpurs_eval_thunk('Data_Functor_mapFlipped')))((((($dictBind)->Apply0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))))->Functor0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
$applyRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_applyRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_applyRWST')))($dictBind);
...
$applyRWST2 = ($applyRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Bind_Bind__dollar__Dict'] ?? \Control\Bind\phpurs_eval_thunk('Control_Bind_Bind__dollar__Dict')))((object)["bind" => (function() use ($bind, $mapFlipped, $append) {
...
$m = $__case_0;
$f1 = $__case_1;
return (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($bind, $m, $f1, $mapFlipped, $append) {
...
$result = ($__case_0)->v1;
$writer = ($__case_0)->v2;
return (($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($state, $result, ($append)($w, $writer));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$lift2 = (($GLOBALS['Control_Apply_lift2'] ?? \Control\Apply\phpurs_eval_thunk('Control_Apply_lift2')))(($applyRWST1)($dictMonoid));
...
$pure = (($GLOBALS['Control_Applicative_pure'] ?? \Control\Applicative\phpurs_eval_thunk('Control_Applicative_pure')))((($dictMonad)->Applicative0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
$applyRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_applyRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_applyRWST')))((($dictMonad)->Bind1)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
...
$mempty = (($GLOBALS['Data_Monoid_mempty'] ?? \Data\Monoid\phpurs_eval_thunk('Data_Monoid_mempty')))($dictMonoid);
$applyRWST2 = ($applyRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Applicative_Applicative__dollar__Dict'] ?? \Control\Applicative\phpurs_eval_thunk('Control_Applicative_Applicative__dollar__Dict')))((object)["pure" => (function() use ($pure, $mempty) {
  $__fn = function($a) use ($pure, $mempty, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($pure, $a, $mempty) {
...
$applicativeRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_applicativeRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_applicativeRWST')))($dictMonad);
$bindRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_bindRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_bindRWST')))((($dictMonad)->Bind1)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
...
$bindRWST2 = ($bindRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Monad__dollar__Dict'] ?? \Control\Monad\phpurs_eval_thunk('Control_Monad_Monad__dollar__Dict')))((object)["Applicative0" => (function() use ($applicativeRWST2) {
...
$pure = (($GLOBALS['Control_Applicative_pure'] ?? \Control\Applicative\phpurs_eval_thunk('Control_Applicative_pure')))((($dictMonad)->Applicative0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
$monadRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_monadRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadRWST')))($dictMonad);
...
$monadRWST2 = ($monadRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Reader_Class_MonadAsk__dollar__Dict'] ?? \Control\Monad\Reader\Class\phpurs_eval_thunk('Control_Monad_Reader_Class_MonadAsk__dollar__Dict')))((object)["ask" => (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($pure, $mempty) {
  ...
  if ($__num < 2) {
    ...
    $__res = ($pure)((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s, $r, $mempty));
  return $__num > 2 ? $__res(...array_slice(func_get_args(), 2)) : $__res;
  };
  return $__fn;
...
$monadAskRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_monadAskRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadAskRWST')))($dictMonad);
...
$monadAskRWST2 = ($monadAskRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Reader_Class_MonadReader__dollar__Dict'] ?? \Control\Monad\Reader\Class\phpurs_eval_thunk('Control_Monad_Reader_Class_MonadReader__dollar__Dict')))((object)["local" => (function() {
...
$lift = (($GLOBALS['Control_Monad_Trans_Class_lift'] ?? \Control\Monad\Trans\Class\phpurs_eval_thunk('Control_Monad_Trans_Class_lift')))((($GLOBALS['Control_Monad_RWS_Trans_monadTransRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadTransRWST')))($dictMonoid));
...
$monadRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_monadRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadRWST')))($Monad0, $dictMonoid);
    $__res = (($GLOBALS['Effect_Class_MonadEffect__dollar__Dict'] ?? \Effect\Class\phpurs_eval_thunk('Effect_Class_MonadEffect__dollar__Dict')))((object)["liftEffect" => (($GLOBALS['Control_Monad_RWS_Trans_compose'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_compose')))(($lift)($Monad0), (($GLOBALS['Effect_Class_liftEffect'] ?? \Effect\Class\phpurs_eval_thunk('Effect_Class_liftEffect')))($dictMonadEffect)), "Monad0" => (function() use ($monadRWST1) {
...
$monadRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_monadRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadRWST')))($Monad0);
...
$mempty = (($GLOBALS['Data_Monoid_mempty'] ?? \Data\Monoid\phpurs_eval_thunk('Data_Monoid_mempty')))($dictMonoid);
$monadRWST2 = ($monadRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Rec_Class_MonadRec__dollar__Dict'] ?? \Control\Monad\Rec\Class\phpurs_eval_thunk('Control_Monad_Rec_Class_MonadRec__dollar__Dict')))((object)["tailRecM" => (function() use ($bind, $pure, $append, $tailRecM, $mempty) {
...
case "Loop":
$x = ($__case_0)->v0;
$__case_res_0 = (($GLOBALS['Control_Monad_Rec_Class_Loop'] ?? \Control\Monad\Rec\Class\phpurs_eval_thunk('Control_Monad_Rec_Class_Loop')))((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($state__prime__, $x, ($append)($writer, $writer__prime__)));
break;
case "Done":
$y = ($__case_0)->v0;
$__case_res_0 = (($GLOBALS['Control_Monad_Rec_Class_Done'] ?? \Control\Monad\Rec\Class\phpurs_eval_thunk('Control_Monad_Rec_Class_Done')))((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($state__prime__, $y, ($append)($writer, $writer__prime__)));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
break;
  ...
  return $__fn;
    ...
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($tailRecM, $k__prime__, $a, $mempty) {
  ...
  if ($__num < 2) {
    ...
    $__res = ($tailRecM)(($k__prime__)($r), (($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s, $a, $mempty));
  return $__num > 2 ? $__res(...array_slice(func_get_args(), 2)) : $__res;
  };
  return $__fn;
})());
...
$mempty = (($GLOBALS['Data_Monoid_mempty'] ?? \Data\Monoid\phpurs_eval_thunk('Data_Monoid_mempty')))($dictMonoid);
$monadRWST2 = ($monadRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_State_Class_MonadState__dollar__Dict'] ?? \Control\Monad\State\Class\phpurs_eval_thunk('Control_Monad_State_Class_MonadState__dollar__Dict')))((object)["state" => (function() use ($pure, $mempty) {
  $__fn = function($f) use ($pure, $mempty, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($f, $pure, $mempty) {
...
return ($pure)((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s__prime__, $a, $mempty));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$monadRWST2 = ($monadRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Writer_Class_MonadTell__dollar__Dict'] ?? \Control\Monad\Writer\Class\phpurs_eval_thunk('Control_Monad_Writer_Class_MonadTell__dollar__Dict')))((object)["tell" => (function() use ($pure) {
  $__fn = function($w) use ($pure, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($pure, $w) {
  ...
  if ($__num < 2) {
    ...
    $__res = ($pure)((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s, ($GLOBALS['Data_Unit_unit'] ?? \Data\Unit\phpurs_eval_thunk('Data_Unit_unit')), $w));
  return $__num > 2 ? $__res(...array_slice(func_get_args(), 2)) : $__res;
  };
  return $__fn;
})());
...
$bind = (($GLOBALS['Control_Bind_bind'] ?? \Control\Bind\phpurs_eval_thunk('Control_Bind_bind')))((($dictMonad)->Bind1)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
$pure = (($GLOBALS['Control_Applicative_pure'] ?? \Control\Applicative\phpurs_eval_thunk('Control_Applicative_pure')))((($dictMonad)->Applicative0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
$monadTellRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_monadTellRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadTellRWST')))($dictMonad);
...
$monadTellRWST2 = ($monadTellRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Writer_Class_MonadWriter__dollar__Dict'] ?? \Control\Monad\Writer\Class\phpurs_eval_thunk('Control_Monad_Writer_Class_MonadWriter__dollar__Dict')))((object)["listen" => (function() use ($bind, $pure) {
  $__fn = function($m) use ($bind, $pure, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($m, $bind, $pure) {
...
$a = ($__case_0)->v1;
$w = ($__case_0)->v2;
return ($pure)((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s__prime__, (($GLOBALS['Data_Tuple_Tuple'] ?? \Data\Tuple\phpurs_eval_thunk('Data_Tuple_Tuple')))($a, $w), $w));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$f = (($__case_0)->v1)->v1;
$w = ($__case_0)->v2;
return ($pure)((($GLOBALS['Control_Monad_RWS_Trans_RWSResult'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWSResult')))($s__prime__, $a, ($f)($w)));
} else {
throw new \Exception("Pattern match failure");
};
  };
...
$lift = (($GLOBALS['Control_Monad_Trans_Class_lift'] ?? \Control\Monad\Trans\Class\phpurs_eval_thunk('Control_Monad_Trans_Class_lift')))((($GLOBALS['Control_Monad_RWS_Trans_monadTransRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadTransRWST')))($dictMonoid), $Monad0);
$monadRWST2 = ($monadRWST1)($dictMonoid);
    $__res = (($GLOBALS['Control_Monad_Error_Class_MonadThrow__dollar__Dict'] ?? \Control\Monad\Error\Class\phpurs_eval_thunk('Control_Monad_Error_Class_MonadThrow__dollar__Dict')))((object)["throwError" => (function() use ($lift, $throwError) {
...
$monadThrowRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_monadThrowRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadThrowRWST')))((($dictMonadError)->MonadThrow0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
...
$monadThrowRWST2 = ($monadThrowRWST1)($dictMonoid);
  ...
  $__num = func_num_args();
  if ($__num < 2) {
    if ($__num === 1) return function($h) use ($m, &$__fn) { return $__fn($m, $h); };
    return phpurs_curry_fallback($__fn, func_get_args(), 2);
  }
    $__res = (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($catchError, $m, $h) {
...
$monadRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_monadRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_monadRWST')))($Monad0, $dictMonoid);
    $__res = (($GLOBALS['Control_Monad_ST_Class_MonadST__dollar__Dict'] ?? \Control\Monad\ST\Class\phpurs_eval_thunk('Control_Monad_ST_Class_MonadST__dollar__Dict')))((object)["liftST" => (($GLOBALS['Control_Monad_RWS_Trans_compose'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_compose')))(($lift)($Monad0), (($GLOBALS['Control_Monad_ST_Class_liftST'] ?? \Control\Monad\ST\Class\phpurs_eval_thunk('Control_Monad_ST_Class_liftST')))($dictMonadST)), "Monad0" => (function() use ($monadRWST1) {
  $__fn = function($__dollar____unused) use ($monadRWST1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$applicativeRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_applicativeRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_applicativeRWST')))($dictMonad);
$semigroupRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_semigroupRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_semigroupRWST')))((($dictMonad)->Bind1)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
...
$pure = (($GLOBALS['Control_Applicative_pure'] ?? \Control\Applicative\phpurs_eval_thunk('Control_Applicative_pure')))(($applicativeRWST1)($dictMonoid));
...
$semigroupRWST3 = ($semigroupRWST2)((($dictMonoid1)->Semigroup0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
    $__res = (($GLOBALS['Data_Monoid_Monoid__dollar__Dict'] ?? \Data\Monoid\phpurs_eval_thunk('Data_Monoid_Monoid__dollar__Dict')))((object)["mempty" => ($pure)((($GLOBALS['Data_Monoid_mempty'] ?? \Data\Monoid\phpurs_eval_thunk('Data_Monoid_mempty')))($dictMonoid1)), "Semigroup0" => (function() use ($semigroupRWST3) {
...
$functorRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_functorRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_functorRWST')))((($dictAlt)->Functor0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
...
$m = $__case_0;
$n = $__case_1;
return (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($alt, $m, $n) {
...
$altRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_altRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_altRWST')))((($dictPlus)->Alt0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
    $__res = (($GLOBALS['Control_Plus_Plus__dollar__Dict'] ?? \Control\Plus\phpurs_eval_thunk('Control_Plus_Plus__dollar__Dict')))((object)["empty" => (($GLOBALS['Control_Monad_RWS_Trans_RWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_RWST')))((function() use ($empty) {
...
$plusRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_plusRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_plusRWST')))((($dictAlternative)->Plus1)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
...
$applicativeRWST1 = (($GLOBALS['Control_Monad_RWS_Trans_applicativeRWST'] ?? \Control\Monad\RWS\Trans\phpurs_eval_thunk('Control_Monad_RWS_Trans_applicativeRWST')))($dictMonad, $dictMonoid);
    $__res = (($GLOBALS['Control_Alternative_Alternative__dollar__Dict'] ?? \Control\Alternative\phpurs_eval_thunk('Control_Alternative_Alternative__dollar__Dict')))((object)["Applicative0" => (function() use ($applicativeRWST1) {
