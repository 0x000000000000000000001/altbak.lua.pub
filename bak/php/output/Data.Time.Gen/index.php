...
if (true) {
$v = $__case_0;
$__case_res_3 = ($v)->chooseInt;
} else {
throw new \Exception("Pattern match failure");
};
$chooseInt = $__case_res_3;
$__case_0 = $dict;
$__case_res_4 = null;
if (true) {
$v = $__case_0;
...
if (true) {
$v = $__case_0;
$__case_res_9 = ($v)->foldMap1;
} else {
throw new \Exception("Pattern match failure");
};
$foldMap1 = ($__case_res_9)($__global_Data_Semigroup_Last_semigroupLast);
$__case_0 = $dict;
$__case_res_10 = null;
if (true) {
$v = $__case_0;
...
if (true) {
$v = $__case_0;
$__case_res_24 = ($v)->chooseInt;
} else {
throw new \Exception("Pattern match failure");
};
$chooseInt = $__case_res_24;
$__case_0 = $dict;
$__case_res_25 = null;
if (true) {
$v = $__case_0;
$__case_res_25 = ($v)->pure;
} else {
throw new \Exception("Pattern match failure");
};
$pure = $__case_res_25;
...
if (true) {
$v = $__case_0;
$__case_res_26 = ($v)->foldl;
} else {
throw new \Exception("Pattern match failure");
};
$foldl3 = $__case_res_26;
$length = ((function() use ($foldl3) {
  $__fn = function($dictSemiring) use ($foldl3, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
...
if (true) {
$v = $__case_0;
$__case_res_30 = ($v)->foldMap1;
} else {
throw new \Exception("Pattern match failure");
};
$foldMap1 = ($__case_res_30)($__global_Data_Semigroup_Last_semigroupLast);
$__case_0 = $dict;
$__case_res_31 = null;
if (true) {
$v = $__case_0;
$__case_res_31 = ($v)->foldr;
} else {
throw new \Exception("Pattern match failure");
};
$foldr = $__case_res_31;
...
if (true) {
$v = $__case_0;
$__case_res_45 = ($v)->chooseInt;
} else {
throw new \Exception("Pattern match failure");
};
$chooseInt = $__case_res_45;
$__case_0 = $dict;
$__case_res_46 = null;
if (true) {
$v = $__case_0;
$__case_res_46 = ($v)->pure;
} else {
throw new \Exception("Pattern match failure");
};
$pure = $__case_res_46;
...
if (true) {
$v = $__case_0;
$__case_res_47 = ($v)->foldl;
} else {
throw new \Exception("Pattern match failure");
};
$foldl3 = $__case_res_47;
$length = ((function() use ($foldl3) {
  $__fn = function($dictSemiring) use ($foldl3, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
...
if (true) {
$v = $__case_0;
$__case_res_51 = ($v)->foldMap1;
} else {
throw new \Exception("Pattern match failure");
};
$foldMap1 = ($__case_res_51)($__global_Data_Semigroup_Last_semigroupLast);
$__case_0 = $dict;
$__case_res_52 = null;
if (true) {
$v = $__case_0;
$__case_res_52 = ($v)->foldr;
} else {
throw new \Exception("Pattern match failure");
};
$foldr = $__case_res_52;
...
if (true) {
$v = $__case_0;
$__case_res_66 = ($v)->chooseInt;
} else {
throw new \Exception("Pattern match failure");
};
$chooseInt = $__case_res_66;
$__case_0 = $dict;
$__case_res_67 = null;
if (true) {
$v = $__case_0;
$__case_res_67 = ($v)->pure;
} else {
throw new \Exception("Pattern match failure");
};
$pure = $__case_res_67;
...
if (true) {
$v = $__case_0;
$__case_res_68 = ($v)->foldl;
} else {
throw new \Exception("Pattern match failure");
};
$foldl3 = $__case_res_68;
$length = ((function() use ($foldl3) {
  $__fn = function($dictSemiring) use ($foldl3, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
...
if (true) {
$v = $__case_0;
$__case_res_72 = ($v)->foldMap1;
} else {
throw new \Exception("Pattern match failure");
};
$foldMap1 = ($__case_res_72)($__global_Data_Semigroup_Last_semigroupLast);
$__case_0 = $dict;
$__case_res_73 = null;
if (true) {
$v = $__case_0;
$__case_res_73 = ($v)->foldr;
} else {
throw new \Exception("Pattern match failure");
};
$foldr = $__case_res_73;
...
if (true) {
$v = $__case_0;
$__case_res_74 = ($v)->pure;
} else {
throw new \Exception("Pattern match failure");
};
$pure = $__case_res_74;
    $__res = ($apply)(($apply)(($apply)(($__case_res_1)((function() {
  ...
  $__body = function($dictBoundedEnum) use ($__global_Prim_undefined, $dict, $__global_Data_Unfoldable1_sub, $__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard, $__global_Data_Unfoldable1_unfoldable1Array, $elements, $pure) {
    ...
    if (true) {
$v = $__case_0;
$__case_res_12 = ($v)->bottom;
} else {
throw new \Exception("Pattern match failure");
};
    $bottom = $__case_res_12;
    $__case_0 = $Enum1;
    $__case_res_13 = null;
    if (true) {
$v = $__case_0;
$__case_res_13 = ($v)->succ;
} else {
throw new \Exception("Pattern match failure");
};
    $v = ($__case_res_13)($bottom);
    $__case_0 = $v;
    switch (($__case_0)->tag) {
case "Just":
$a = ($__case_0)->v0;
...
if (true) {
$v = $__case_0;
$__case_res_19 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_19;
...
if (true) {
$v = $__case_0;
$__case_res_20 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr11 = $__case_res_20;
...
if (true) {
$v = $__case_0;
$__case_res_21 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr1 = $__case_res_21;
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})())($__global_Data_Unfoldable1_unfoldable1Array, $a, $__case_res_22);
...
break;
  ...
  $__body = function($dictBoundedEnum) use ($__global_Prim_undefined, $dict, $__global_Data_Unfoldable1_sub, $__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard, $__global_Data_Unfoldable1_unfoldable1Array, $elements, $pure) {
    ...
    if (true) {
$v = $__case_0;
$__case_res_33 = ($v)->bottom;
} else {
throw new \Exception("Pattern match failure");
};
    $bottom = $__case_res_33;
    $__case_0 = $Enum1;
    $__case_res_34 = null;
    if (true) {
$v = $__case_0;
$__case_res_34 = ($v)->succ;
} else {
throw new \Exception("Pattern match failure");
};
    $v = ($__case_res_34)($bottom);
    $__case_0 = $v;
    switch (($__case_0)->tag) {
case "Just":
$a = ($__case_0)->v0;
...
if (true) {
$v = $__case_0;
$__case_res_36 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_36;
$lessThan1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_38 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_38;
$lessThanOrEq1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_40 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_40;
$greaterThanOrEq1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_41 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr11 = $__case_res_41;
$singleton = ((function() use ($unfoldr11, $__global_Data_Unfoldable1_sub) {
  $__fn = function($n, $v = null) use ($unfoldr11, $__global_Data_Unfoldable1_sub, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
if (true) {
$v = $__case_0;
$__case_res_42 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr1 = $__case_res_42;
$go = (function() use ($__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard) {
  $__fn = function($step, $op = null, $to = null, $a = null) use ($__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard, &$__fn) {
  $__num = func_num_args();
  if ($__num < 4) {
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})())($__global_Data_Unfoldable1_unfoldable1Array, $a, $__case_res_43);
return ($elements)(((function() {
  $__fn = function($value0, $value1 = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
break;
  ...
  $__body = function($dictBoundedEnum) use ($__global_Prim_undefined, $dict, $__global_Data_Unfoldable1_sub, $__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard, $__global_Data_Unfoldable1_unfoldable1Array, $elements, $pure) {
    ...
    if (true) {
$v = $__case_0;
$__case_res_54 = ($v)->bottom;
} else {
throw new \Exception("Pattern match failure");
};
    $bottom = $__case_res_54;
    $__case_0 = $Enum1;
    $__case_res_55 = null;
    if (true) {
$v = $__case_0;
$__case_res_55 = ($v)->succ;
} else {
throw new \Exception("Pattern match failure");
};
    $v = ($__case_res_55)($bottom);
    $__case_0 = $v;
    switch (($__case_0)->tag) {
case "Just":
$a = ($__case_0)->v0;
...
if (true) {
$v = $__case_0;
$__case_res_57 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_57;
$lessThan1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_59 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_59;
$lessThanOrEq1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_61 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_61;
$greaterThanOrEq1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_62 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr11 = $__case_res_62;
$singleton = ((function() use ($unfoldr11, $__global_Data_Unfoldable1_sub) {
  $__fn = function($n, $v = null) use ($unfoldr11, $__global_Data_Unfoldable1_sub, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
if (true) {
$v = $__case_0;
$__case_res_63 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr1 = $__case_res_63;
$go = (function() use ($__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard) {
  $__fn = function($step, $op = null, $to = null, $a = null) use ($__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard, &$__fn) {
  $__num = func_num_args();
  if ($__num < 4) {
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})())($__global_Data_Unfoldable1_unfoldable1Array, $a, $__case_res_64);
return ($elements)(((function() {
  $__fn = function($value0, $value1 = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
break;
  ...
  $__body = function($dictBoundedEnum) use ($__global_Prim_undefined, $dict, $__global_Data_Unfoldable1_sub, $__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard, $__global_Data_Unfoldable1_unfoldable1Array, $elements, $pure) {
    ...
    if (true) {
$v = $__case_0;
$__case_res_75 = ($v)->bottom;
} else {
throw new \Exception("Pattern match failure");
};
    $bottom = $__case_res_75;
    $__case_0 = $Enum1;
    $__case_res_76 = null;
    if (true) {
$v = $__case_0;
$__case_res_76 = ($v)->succ;
} else {
throw new \Exception("Pattern match failure");
};
    $v = ($__case_res_76)($bottom);
    $__case_0 = $v;
    switch (($__case_0)->tag) {
case "Just":
$a = ($__case_0)->v0;
...
if (true) {
$v = $__case_0;
$__case_res_78 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_78;
$lessThan1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_80 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_80;
$lessThanOrEq1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_82 = ($v)->compare;
} else {
throw new \Exception("Pattern match failure");
};
$compare3 = $__case_res_82;
$greaterThanOrEq1 = (function() use ($compare3) {
  $__body = function($a1, $a2) use ($compare3) {
    $v = ($compare3)($a1, $a2);
    $__case_0 = $v;
...
if (true) {
$v = $__case_0;
$__case_res_83 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr11 = $__case_res_83;
$singleton = ((function() use ($unfoldr11, $__global_Data_Unfoldable1_sub) {
  $__fn = function($n, $v = null) use ($unfoldr11, $__global_Data_Unfoldable1_sub, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
if (true) {
$v = $__case_0;
$__case_res_84 = ($v)->unfoldr1;
} else {
throw new \Exception("Pattern match failure");
};
$unfoldr1 = $__case_res_84;
$go = (function() use ($__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard) {
  $__fn = function($step, $op = null, $to = null, $a = null) use ($__global_Data_Enum_bind, $__global_Data_Enum_voidLeft, $__global_Data_Enum_guard, &$__fn) {
  $__num = func_num_args();
  if ($__num < 4) {
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})())($__global_Data_Unfoldable1_unfoldable1Array, $a, $__case_res_85);
return ($elements)(((function() {
  $__fn = function($value0, $value1 = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
