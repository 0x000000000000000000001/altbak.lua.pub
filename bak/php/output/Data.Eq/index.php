...
$__global_Data_Eq_eqArray = ($GLOBALS['Data_Eq_eqArray'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqArray'));
    $__res = (($__global_Data_Eq_eqArray)($dictEq))->eq;
...
$__global_Data_Eq_Eq__dollar__Dict = ($GLOBALS['Data_Eq_Eq__dollar__Dict'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_Eq__dollar__Dict'));
$__global_Type_Proxy_Proxy = ($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy'));
    $__res = ($__global_Data_Eq_Eq__dollar__Dict)((object)["eq" => (($dictEqRecord)->eqRecord)($__global_Type_Proxy_Proxy)]);
...
$__global_Data_Eq_eqArrayImpl = ($GLOBALS['Data_Eq_eqArrayImpl'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqArrayImpl'));
    $__res = ($__global_Data_Eq_Eq__dollar__Dict)((object)["eq" => ($__global_Data_Eq_eqArrayImpl)(($dictEq)->eq)]);
    return 1 < $__num ? $__res(...array_slice(func_get_args(), 1)) : $__res;
}
...
$__global_Data_Eq_EqRecord__dollar__Dict = ($GLOBALS['Data_Eq_EqRecord__dollar__Dict'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_EqRecord__dollar__Dict'));
$__global_Type_Proxy_Proxy = ($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy'));
...
$eqRecord1 = ($dictEqRecord)->eqRecord;
    $__res = (function() use ($__global_Data_Eq_EqRecord__dollar__Dict, $eqRecord1, $__global_Type_Proxy_Proxy, $__global_Record_Unsafe_unsafeGet, $__global_Data_HeytingAlgebra_boolConj) {
  $__fn = function($__dollar____unused, $dictIsSymbol = null) use ($__global_Data_Eq_EqRecord__dollar__Dict, $eqRecord1, $__global_Type_Proxy_Proxy, $__global_Record_Unsafe_unsafeGet, $__global_Data_HeytingAlgebra_boolConj, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
$reflectSymbol = ($dictIsSymbol)->reflectSymbol;
    $__res = (function() use ($__global_Data_Eq_EqRecord__dollar__Dict, $eqRecord1, $__global_Type_Proxy_Proxy, $reflectSymbol, $__global_Record_Unsafe_unsafeGet, $__global_Data_HeytingAlgebra_boolConj) {
  $__fn = function($dictEq) use ($__global_Data_Eq_EqRecord__dollar__Dict, $eqRecord1, $__global_Type_Proxy_Proxy, $reflectSymbol, $__global_Record_Unsafe_unsafeGet, $__global_Data_HeytingAlgebra_boolConj, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
$eq3 = ($dictEq)->eq;
    $__res = ($__global_Data_Eq_EqRecord__dollar__Dict)((object)["eqRecord" => (function() use ($eqRecord1, $__global_Type_Proxy_Proxy, $reflectSymbol, $__global_Record_Unsafe_unsafeGet, $__global_Data_HeytingAlgebra_boolConj, $eq3) {
  $__fn = function($v, $ra = null, $rb = null) use ($eqRecord1, $__global_Type_Proxy_Proxy, $reflectSymbol, $__global_Record_Unsafe_unsafeGet, $__global_Data_HeytingAlgebra_boolConj, $eq3, &$__fn) {
  $__num = func_num_args();
  if ($__num < 3) {
...
$tail = ($eqRecord1)($__global_Type_Proxy_Proxy, $ra, $rb);
$key = ($reflectSymbol)($__global_Type_Proxy_Proxy);
$get = ($__global_Record_Unsafe_unsafeGet)($key);
    $__res = ($__global_Data_HeytingAlgebra_boolConj)(($eq3)(($get)($ra), ($get)($rb)), $tail);
  return $__num > 3 ? $__res(...array_slice(func_get_args(), 3)) : $__res;
  };
  return $__fn;
})()]);
