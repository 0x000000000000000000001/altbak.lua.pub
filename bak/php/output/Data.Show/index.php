...
$showRecordFields1 = (($GLOBALS['Data_Show_showRecordFields'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_showRecordFields')))($dictShowRecordFields);
    $__res = (($GLOBALS['Data_Show_Show__dollar__Dict'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_Show__dollar__Dict')))((object)["show" => (function() use ($showRecordFields1) {
  $__fn = function($record) use ($showRecordFields1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))("{", (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(($showRecordFields1)(($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy')), $record), "}"));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]);
...
function Data_Show_showArray($dictShow) {
  ...
  if ($__num < 1) {
    ...
    $__res = (($GLOBALS['Data_Show_Show__dollar__Dict'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_Show__dollar__Dict')))((object)["show" => (($GLOBALS['Data_Show_showArrayImpl'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_showArrayImpl')))((($GLOBALS['Data_Show_show'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_show')))($dictShow))]);
    return 1 < $__num ? $__res(...array_slice(func_get_args(), 1)) : $__res;
}
...
$show1 = (($GLOBALS['Data_Show_show'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_show')))($dictShow);
    $__res = (($GLOBALS['Data_Show_ShowRecordFields__dollar__Dict'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_ShowRecordFields__dollar__Dict')))((object)["showRecordFields" => (function() use ($showRecordFields1, $reflectSymbol, $show1) {
...
$tail = ($showRecordFields1)(($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy')), $record);
$key = ($reflectSymbol)(($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy')));
$focus = (($GLOBALS['Record_Unsafe_unsafeGet'] ?? \Record\Unsafe\phpurs_eval_thunk('Record_Unsafe_unsafeGet')))($key, $record);
    $__res = (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(" ", (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))($key, (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(": ", (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(($show1)($focus), (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(",", $tail)))));
  return $__num > 2 ? $__res(...array_slice(func_get_args(), 2)) : $__res;
  };
  return $__fn;
})()]);
...
$show1 = (($GLOBALS['Data_Show_show'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_show')))($dictShow);
    $__res = (($GLOBALS['Data_Show_ShowRecordFields__dollar__Dict'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_ShowRecordFields__dollar__Dict')))((object)["showRecordFields" => (function() use ($reflectSymbol, $show1) {
...
$key = ($reflectSymbol)(($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy')));
$focus = (($GLOBALS['Record_Unsafe_unsafeGet'] ?? \Record\Unsafe\phpurs_eval_thunk('Record_Unsafe_unsafeGet')))($key, $record);
    $__res = (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(" ", (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))($key, (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(": ", (($GLOBALS['Data_Show_append'] ?? \Data\Show\phpurs_eval_thunk('Data_Show_append')))(($show1)($focus), " "))));
  return $__num > 2 ? $__res(...array_slice(func_get_args(), 2)) : $__res;
  };
  return $__fn;
})()]);
