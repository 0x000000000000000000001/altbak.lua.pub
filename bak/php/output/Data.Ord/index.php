...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqVoid'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqVoid'));
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqUnit'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqUnit'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqString'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqString'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqRowNil'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqRowNil'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqProxy'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqProxy'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
...
break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Ordering_eqOrdering'] ?? \Data\Ordering\phpurs_eval_thunk('Data_Ordering_eqOrdering'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqNumber'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqNumber'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqInt'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqInt'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqChar'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqChar'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eqBoolean'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqBoolean'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
  ...
  if ($__num < 1) {
    ...
    $__res = (($GLOBALS['Data_Ord_compare'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_compare')))((($GLOBALS['Data_Ord_ordArray'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_ordArray')))($dictOrd));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})(), "Eq10" => (function() {
  ...
  if ($__num < 1) {
    ...
    $__res = ($GLOBALS['Data_Eq_eq1Array'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eq1Array'));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]); break;
...
$eqRec1 = (($GLOBALS['Data_Ord_eqRec'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_eqRec')))((($dictOrdRecord)->EqRecord0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
    $__res = (($GLOBALS['Data_Ord_Ord__dollar__Dict'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_Ord__dollar__Dict')))((object)["compare" => (($GLOBALS['Data_Ord_compareRecord'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_compareRecord')))($dictOrdRecord, ($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy'))), "Eq0" => (function() use ($eqRec1) {
...
$compare3 = (($GLOBALS['Data_Ord_compare'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_compare')))($dictOrd);
...
$Semiring0 = (($dictRing)->Semiring0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined')));
$zero = (($GLOBALS['Data_Semiring_zero'] ?? \Data\Semiring\phpurs_eval_thunk('Data_Semiring_zero')))($Semiring0);
$negate1 = (($GLOBALS['Data_Ring_negate'] ?? \Data\Ring\phpurs_eval_thunk('Data_Ring_negate')))($dictRing);
$one = (($GLOBALS['Data_Semiring_one'] ?? \Data\Semiring\phpurs_eval_thunk('Data_Semiring_one')))($Semiring0);
...
$compare3 = (($GLOBALS['Data_Ord_compare'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_compare')))($dictOrd);
$eqArray = (($GLOBALS['Data_Eq_eqArray'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqArray')))((($dictOrd)->Eq0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
...
break;
case "GT":
return (($GLOBALS['Data_Ord_negate'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_negate')))(1);
break;
default:
throw new \Exception("Pattern match failure");
break;
  ...
  return $__fn;
    ...
    $__res = (($GLOBALS['Data_Ord_Ord__dollar__Dict'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_Ord__dollar__Dict')))((object)["compare" => (function() use ($toDelta) {
  ...
  if ($__num < 2) {
    ...
    $__res = (($GLOBALS['Data_Ord_compare2'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_compare2')))(0, (($GLOBALS['Data_Ord_ordArrayImpl'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_ordArrayImpl')))($toDelta, $xs, $ys));
  return $__num > 2 ? $__res(...array_slice(func_get_args(), 2)) : $__res;
  };
  return $__fn;
...
$compareRecord1 = (($GLOBALS['Data_Ord_compareRecord'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_compareRecord')))($dictOrdRecord);
$eqRowCons = (($GLOBALS['Data_Eq_eqRowCons'] ?? \Data\Eq\phpurs_eval_thunk('Data_Eq_eqRowCons')))((($dictOrdRecord)->EqRecord0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))), ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined')));
...
$compare3 = (($GLOBALS['Data_Ord_compare'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_compare')))($dictOrd);
$eqRowCons2 = ($eqRowCons1)((($dictOrd)->Eq0)(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))));
    $__res = (($GLOBALS['Data_Ord_OrdRecord__dollar__Dict'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_OrdRecord__dollar__Dict')))((object)["compareRecord" => (function() use ($reflectSymbol, $compare3, $compareRecord1) {
  $__body = function($v, $ra, $rb) use ($reflectSymbol, $compare3, $compareRecord1) {
    $unsafeGet__prime__ = ($GLOBALS['Record_Unsafe_unsafeGet'] ?? \Record\Unsafe\phpurs_eval_thunk('Record_Unsafe_unsafeGet'));
    ...
    $__case_0 = (($GLOBALS['Data_Ord_notEq'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_notEq')))($left, ($GLOBALS['Data_Ordering_EQ'] ?? \Data\Ordering\phpurs_eval_thunk('Data_Ordering_EQ')));
    if (($__case_0 === true)) {
return $left;
} else {
if (true) {
return ($compareRecord1)(($GLOBALS['Type_Proxy_Proxy'] ?? \Type\Proxy\phpurs_eval_thunk('Type_Proxy_Proxy')), $ra, $rb);
} else {
throw new \Exception("Pattern match failure");
};
};
...
$min1 = (($GLOBALS['Data_Ord_min'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_min')))($dictOrd);
$max1 = (($GLOBALS['Data_Ord_max'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_max')))($dictOrd);
...
$greaterThanOrEq1 = (($GLOBALS['Data_Ord_greaterThanOrEq'] ?? \Data\Ord\phpurs_eval_thunk('Data_Ord_greaterThanOrEq')))($dictOrd);
