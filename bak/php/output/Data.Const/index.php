...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Data_Const_append': $v = (function() {
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Const_invariantConst': $v = (function() {
  $__case_0 = ($GLOBALS['Data_Const_functorConst'] ?? \Data\Const\phpurs_eval_thunk('Data_Const_functorConst'));
  $__case_res_0 = null;
  if (true) {
$v = $__case_0;
$__case_res_0 = ($v)->map;
...
$show = $__case_res_0;
    $__res = (object)["show" => (function() use ($__global_Data_Const_append, $show) {
  $__body = function($v) use ($__global_Data_Const_append, $show) {
    $__case_0 = $v;
    if (true) {
$x = $__case_0;
return ($__global_Data_Const_append)("(Const ", ($__global_Data_Const_append)(($show)($x), ")"));
} else {
throw new \Exception("Pattern match failure");
};
  };
  $__fn = function($v) use ($__global_Data_Const_append, $show, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$eq = $__case_res_1;
$eq1Const1 = (object)["eq1" => (function() use ($eq) {
  $__fn = function($dictEq1) use ($eq, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$applyConst1 = (object)["apply" => (function() use ($append1) {
  $__body = function($v, $v1) use ($append1) {
    $__case_0 = $v;
    $__case_1 = $v1;
    if (true) {
